    ...
    <div class="page-content">
        <div class="row">
            <div class="col-md-12">
                ...
                <h1>Editar Servicio de Mapa con ID:{{ $servicio->id }}</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin.servicesmap.update', $servicio->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="nombre" value="{{ $servicio->nombre }}"  id="nombre-text-input" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="descripcion" value="{{ $servicio->descripcion }}"  id="descripcion-text-input" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="wms" value="{{ $servicio->wms }}"   id="wms-text-input" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="mvt" value="{{ $servicio->mvt }}"  id="mvt-text-input" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="geojson" value="{{ $servicio->geojson }}"   id="geojson-text-input" class="form-control">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="geojson-text-input" class="col-sm-2 col-form-label"> URL: Layer Geoserver</label>
                                <div class="col-sm-10">
                                    <input type="text" name="url_layer_geoserver" value="{{ $servicio->url_layer_geoserver }}"   id="geojson-text-input" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-check form-switch" dir="ltr">
                                        <input type="checkbox" class="form-check-input" style="height: 22px; width: 35px;" name="estado" id="estado" {{ $servicio->estado==1 ? "checked" : "" }} >
