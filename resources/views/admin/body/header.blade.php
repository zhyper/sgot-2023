<header id="page-topbar" class="page-top-bar-cuscus" style="background-color: #871D46 !important;">
        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="{{ url('/') }}" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{ asset('logo/pgts3c_logo_agosto_2023-sm.svg') }}" alt="logo-sm-light" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('logo/logo-proyecto-rafis-02_simple.svg') }}" alt="logo-light" height="20">
                    </span>
                </a>
            </div>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-none d-sm-inline-block">
                <button type="button" class="btn header-item waves-effect"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="" src="{{ asset('backend/assets/images/flags/pe.jpg') }}" alt="Header Language" height="16">
                </button>
